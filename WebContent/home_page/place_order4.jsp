...
<html>
    <head>
        ...
        <script>
            function dcard()
            {
                window.location.replace("place_order5.jsp?price="+<%=total_price%>+"");
            }
        </script>
    </head>
    <body>
        ...
        <form name="frm" action="../place_order4_unreg" method="post">
        ...
        <table width="350" border="0" style=" margin-left: 430px; margin-top: 30px">
            ...
            <tr>
                <td height="60" style="color: #333333; font-size: 15px">Amount Payable on Delivery: Rs. <%=total_price%></td>
            </tr>
            <tr>
                <td height="90" align="center"><input type="submit" name="btn1" value="Place Order" style="width: 115px; height: 33px; border:solid 1px #999999; background-color: #990000; color: white; font-size: 14px"></td>
            </tr>
        </table>
        </form>
